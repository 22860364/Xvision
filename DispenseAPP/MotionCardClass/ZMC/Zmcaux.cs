...
public static extern int ZAux_Execute(IntPtr handle, string pszCommand, byte[] psResponse,UInt32 uiResponseLength);
...
public static extern int ZAux_DirectCommand(IntPtr handle, string pszCommand, byte[] psResponse,UInt32 uiResponseLength);
