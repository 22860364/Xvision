...
{
    [Serializable]
    public class DynamicMethodExecute
    {
        readonly Func<object, object[], object> m_execute;

        public DynamicMethodExecute(MethodInfo methodInfo)
        {
            m_execute = this.GetExecuteDelegate(methodInfo);
        }
